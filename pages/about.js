        ...
        <div className='w-full max-w-4xl mx-auto'>
          <div className='space-y-5'>
            ...
            <p>
              ...
              React.js, Next.js, TypeScript, CSS, HTML and much more! New skills
              and techs I want to learn are Vue.js, Flutter and one backend
              framework like Express.js and Django.
            </p>
            <p>
              Fun Facts: I like advanced technologies and electronic devices.
              One of the people that I idolize is Elon Musk. I'm an introvert
              and I like playing multiplayer games with my fris.
            </p>
          </div>
          <div className='pb-4'>
  ...
  return (
    <div>
      ...
      {posts.map((post, index) => (
        <ul key={index} className='px-4 lg:px-0'>
